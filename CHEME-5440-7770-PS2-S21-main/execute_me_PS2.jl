...
plot1=plot(mRNA_steady_state_array[:,1],mRNA_steady_state_array[:,2], xscale=:log10, legend=false)
xlabel!("Inducer concentration (muM)")
ylabel!("Steady state mRNA concentration (muM)")
savefig(plot1,"plotHW.png")